...
nationwide2016$popupText <- paste(strong("State:"), nationwide2016$place, br(), 
                              strong("Winning Party:"), nationwide2016$party, br(),
                              strong("Electoral Votes:"), nationwide2016$votes, br(),
                              strong("Population:"), nationwide2016$popul)
nationwideGEO@data <- 
  nationwideGEO@data %>%
  left_join(nationwide2016, by = c("NAME" = "place"))
