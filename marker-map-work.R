...
states <- data.frame( 
                 ...
                 , votes  = c( 9        ,  3         ,  10        ,  6        ,  55         ,  9         ,  7           ,  3        ,  3                    ,  27       ,  15       ,  4         ,  4         ,  21        ,  11       ,  7        ,  6        ,  9         ,  4        ,  10       ,  12            ,  17       ,  10        ,  6           ,  11       ,  3         ,  5        ,  5         ,  4             ,  15         ,  5          ,  31       ,  15              ,  3            ,  20       ,  7        ,  7         ,  21           ,  4            ,  8              ,  3            ,  11        ,  34       ,  5         ,  3        ,  13       ,  11         ,  5             ,  10        ,  3         )
                 , stringsAsFactors = FALSE
                 )

states$popupText <- paste(strong(states$place), br(), strong("Electoral College Votes:"), states$votes)

leaflet(data = states) %>% 
  setView(lng = -97.3375397, lat = 37.6922417, zoom = 3) %>% 
  addTiles() %>% 
