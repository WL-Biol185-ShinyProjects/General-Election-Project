...
states$popupText <- paste(strong("State:"), states$place, br(), 
                          strong("Winning Party:"), states$party, br(),
                          strong("Electoral College Votes:"), states$votes, br(),
                          strong("Population:"), states$popul)
